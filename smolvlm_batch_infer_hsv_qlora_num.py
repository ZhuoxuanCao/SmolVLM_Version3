...
# python smolvlm_batch_infer_hsv_qlora.py --input ./annotations/annotations_img_init_2obj.jsonl --output ./predictions_2cube/num_obj/predictions_img_init_2obj_v3.jsonl --image_dir ./image_test_batch/image_init_2obj  --enable_hsv_preprocessing --adapter_path ./output_smolvlm_lora/output_smolvlm_lora_V1
